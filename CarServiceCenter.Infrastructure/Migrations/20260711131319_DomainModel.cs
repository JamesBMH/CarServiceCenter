        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAdvisorAdded = table.Column<bool>(type: "boolean", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    BookingId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Technitians", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceTypeItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceTypeItems_ServiceTypes_ServiceTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceTypeItems_ServiceTypeId",
                table: "ServiceTypeItems",
                column: "ServiceTypeId");
